...
// Version with lambdas!!! from 2015T1//
...
public class UI {
    ...
    private JMenuBar initMenuBar() {
        ...
        JMenuItem styledOnOff = new JMenuItem("Styled On/Off");
        styledOnOff.addActionListener(new ActionListener() {
    ...
    /** Reset the point size of the Font of String to be drawn in the graphics output region to the default value.
     *  This will be the size of the font of any String drawn after this.
     */
    ...
    /** Reset the width of the lines (in pixels) for lines drawn in the graphics output region to the default value.
     *  This will be the width of lines drawn with drawLine and the outlines of shapes drawn after this.
     */
    public static void resetLineWidth(){
        theUI.canvas.setLineWidth(DEFAULT_LINEWIDTH);
    }
...
/*==== OUTPUT to TEXT PANE=============================================*/
    ...
    /** Print an array of Objects to the text pane.
     */
    public static void print(Object[] ar) {
	print(Arrays.deepToString(ar));
    }

    /** Print an array of int to the text pane.
     */
    public static void print(int[] ar) {
	print(Arrays.toString(ar));
    }

    /** Print an array of double to the text pane.
     */
    ...
    /** Print an array of Objects to the text pane and start a new line.
     */
    public static void println(Object[] ar) {
	print(Arrays.deepToString(ar)+"\n");
    }

    /** Print an array of int to the text pane and start a new line.
     */
    public static void println(int[] ar) {
	print(Arrays.toString(ar)+"\n");
    }

    /** Print an array of double to the text pane and start a new line.
     */
    public static void println(double[] ar) {
	print(Arrays.toString(ar)+"\n");
    }
	...
	ArrayList<Double> ans = new ArrayList<Double>();
        while (true){
	    String value = askToken(">"); // will deal with inputSource if it is set
	...
	ArrayList<String> ans = new ArrayList<String>();
        while (true){
	    String value = askString(">"); // will deal with inputSource if it is set
	    if ("".equals(value)){
		return ans;
	    }
	    ans.add(value);
