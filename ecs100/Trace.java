...
public class Trace {
    ...
    /** Print an array of Objects into the trace window, if the trace window is
     * currently showing.  Does nothing if the trace window is hidden.
     */
    ...
    /** Print an array of int into the trace window, if the trace window is
     * currently showing.  Does nothing if the trace window is hidden.
     */
    ...
    /** Print an array of double into the trace window, if the trace window is
     * currently showing.  Does nothing if the trace window is hidden.
     */
    ...
    /** Print an array of Objects followed by a new line in the trace window,
     * if the trace window is currently showing.
     * Does nothing if the trace window is hidden.
     */
    ...
    /** Print an array of int followed by a new line in the trace window,
     * if the trace window is currently showing.
     * Does nothing if the trace window is hidden.
     */
    ...
    /** Print an array of double followed by a new line in the trace window,
     * if the trace window is currently showing.
     * Does nothing if the trace window is hidden.
     */
